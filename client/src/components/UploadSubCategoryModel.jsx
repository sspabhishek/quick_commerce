...
const UploadSubCategoryModel = ({ close, fetchdata }) => {
    ...
    // console.log("All Category sub category", allCategory);
    ...
    // console.log("Sub Cate data", subCategoryData);
                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                            ...
                            <div className='flex flex-wrap gap-2'>
                                {
                                    subCategoryData.category.map((cat, index) => {
                                        return (
                                            <p key={cat._id + "selectedValue"} className='bg-white shadow-md px-1 flex items-center gap-2 m-2'>
                                                {cat.name}
                    ...
                    <button
                        className={`px-4 py-2 border
                                ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-primary-200" : "bg-gray-400 "}
                                font-semibold

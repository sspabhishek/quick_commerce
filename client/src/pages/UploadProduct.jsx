                  ...
                  data.image.map((img, index) => {
                    return (
                      <div key={img + index} className='h-20 w-20 mt-1 min-w-20 bg-blue-50 border relative group'>
                        ...
                        />
                        <div onClick={() => handleDeleteImage(index)} className='absolute bottom-0 right-0 p-1 bg-red-500 text-white hover:bg-red-700 rounded-tl bg-opacity-70 hidden group-hover:block cursor-pointer'>
                          <MdDelete />
                        </div>
